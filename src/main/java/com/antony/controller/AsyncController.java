...
public class AsyncController {
    ...
    @GetMapping(value = "/email/servletReq")
    ...
    /**
     * 方式2： 使用很简单，直接返回的参数包裹一层callable即可，可以继承WebMvcConfigurerAdapter类来设置默认线程池和超时处理
     * @return
     */
    ...
    /**
     * 方式4： DeferredResult可以处理一些相对复杂一些的业务逻辑，最主要还是可以在另一个线程里面进行业务处理及返回，即可在两个完全不相干的线程间的通信。
     * @return
     */
    @GetMapping(value = "/email/deferredResultReq")
    @ResponseBody
